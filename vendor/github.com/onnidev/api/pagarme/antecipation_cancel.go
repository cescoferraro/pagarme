...
// AntecipationsCancel dsjkfndsfkfjng
func (api *API) AntecipationsCancel(ctx context.Context, recipientID, bulkID string) (
	...
	URL.Path += "/1/recipients/" + recipientID + "/bulk_anticipations/" + bulkID + "/cancel"
