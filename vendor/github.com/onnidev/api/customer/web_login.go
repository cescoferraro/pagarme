...
func FB(w http.ResponseWriter, r *http.Request) {
	...
	oauthStateString := chi.URLParam(r, "location")
...
func redirect() string {
	if viper.GetString("env") == "homolog" {
		log.Println("homolog")
		return "https://canary.onni.live/customer/redirect"
	}
	if viper.GetString("env") == "production" {
		log.Println("production")
		return "https://api.onni.live/customer/redirect"
	}
	log.Println("dev")
	return "http://localhost:7000/customer/redirect"
}
