...
func UpdateImage(w http.ResponseWriter, r *http.Request) {
	...
	patchedParty := types.Party{}
	_, err = repo.Collection.
		Find(bson.M{"_id": bson.ObjectIdHex(chi.URLParam(r, "partyId"))}).
		Apply(change, &patchedParty)
	if err != nil {
		shared.MakeONNiError(w, r, 400, err)
		return
	}
	render.Status(r, http.StatusOK)
	render.JSON(w, r, patchedParty)
}
